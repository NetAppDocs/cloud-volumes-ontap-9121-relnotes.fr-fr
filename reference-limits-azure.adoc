...
. La création de volume FlexVol jusqu'à une taille maximale de 300 Tio est prise en charge avec System Manager à partir de Cloud Volumes ONTAP 9.12.1 P2.
